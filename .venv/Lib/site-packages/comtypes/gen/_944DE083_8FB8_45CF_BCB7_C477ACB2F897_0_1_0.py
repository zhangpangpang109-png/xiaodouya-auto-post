...
__all__ = [
    'UIA_ScrollVerticalScrollPercentPropertyId', 'TextUnit_Line',
    'TextUnit_Document', 'ZoomUnit_LargeDecrement',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_SelectionItemPatternId', 'NavigateDirection_NextSibling',
    'UIA_SearchLandmarkTypeId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'ProviderOptions_ClientSideProvider',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_ProcessIdPropertyId', 'UIA_GridItemContainingGridPropertyId',
    'UIA_OverlineColorAttributeId', 'UIA_MenuItemControlTypeId',
    'UIA_WindowCanMaximizePropertyId',
    'UIA_LegacyIAccessibleNamePropertyId', 'Polite',
    'IUIAutomationElement5', 'UIA_SelectionItemIsSelectedPropertyId',
    'StyleId_Normal', 'UIA_IsTransformPatternAvailablePropertyId',
    'TextUnit_Format', 'UIA_GroupControlTypeId',
    'UIA_GridItemRowPropertyId', 'UIA_TextEdit_TextChangedEventId',
    'UIA_LandmarkTypePropertyId',
    'ProviderOptions_NonClientAreaProvider',
    'UIA_ControllerForPropertyId', 'UIA_ComboBoxControlTypeId',
    ...
    'ProviderOptions_ProviderOwnsSetFocus', 'IUIAutomationElement9',
    'AnnotationType_EditingLockedChange', 'UIA_TextPattern2Id',
    'StyleId_Heading4', 'UIA_WindowIsTopmostPropertyId',
    'IUIAutomationTextPattern', 'UIA_StrikethroughColorAttributeId',
    'UIA_LinkAttributeId', 'TextEditChangeType_AutoComplete',
    'NotificationProcessing_ImportantAll', 'UIA_InvokePatternId',
    'UIA_ImageControlTypeId', 'IUIAutomation3',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_WindowIsModalPropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'ScrollAmount', 'StructureChangeType_ChildrenReordered',
    'UIA_LiveSettingPropertyId',
    'UIA_SelectionCanSelectMultiplePropertyId', 'TreeScope_Parent',
    'UIA_LevelPropertyId', 'StyleId_Title',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_AnnotationAuthorPropertyId', 'IUIAutomationEventHandler',
    'UIA_ProgressBarControlTypeId', 'IUIAutomationDragPattern',
    'UIA_TableRowOrColumnMajorPropertyId', 'UIA_TableControlTypeId',
    'StructureChangeType_ChildRemoved',
    'UIA_HasKeyboardFocusPropertyId', 'UiaChangeInfo',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_ScrollItemPatternId', 'UIA_TransformCanMovePropertyId',
    'UIA_MarginTrailingAttributeId', 'IUIAutomationElement2',
    'IUIAutomationElement3', 'UIA_IndentationTrailingAttributeId',
    'IUIAutomationAndCondition', 'IUIAutomationTableItemPattern',
    'UIA_Selection_InvalidatedEventId', 'StyleId_Heading2',
    'UIA_TableItemColumnHeaderItemsPropertyId', 'StyleId_Heading7',
    'UIA_DockPatternId', 'StyleId_Heading9', 'IUIAutomationElement',
    'UIA_BoundingRectanglePropertyId',
    'IUIAutomationTransformPattern2', 'UIA_Drag_DragCompleteEventId',
    'UIA_ControlTypePropertyId', 'IUIAutomationGridItemPattern',
    'UIA_AppBarControlTypeId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_IndentationLeadingAttributeId', 'UIA_DocumentControlTypeId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'IUIAutomationTextRange', 'UIA_CaretPositionAttributeId',
    'UIA_ValueIsReadOnlyPropertyId', 'LiveSetting',
    'UIA_ProviderDescriptionPropertyId', 'HeadingLevel6',
    'UIA_IsInvokePatternAvailablePropertyId', 'IUIAutomation5',
    'UIA_RadioButtonControlTypeId', 'IUIAutomationSelectionPattern',
    'UIA_TextChildPatternId', 'UIA_MultipleViewPatternId',
    'UIA_WindowWindowVisualStatePropertyId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_DragDropEffectPropertyId', 'IUIAutomationGridPattern',
    'UIA_ActiveTextPositionChangedEventId', 'UIA_CultureAttributeId',
    'UIA_ItemStatusPropertyId', 'UIA_HeaderItemControlTypeId',
    'UIA_IsSubscriptAttributeId', 'UIA_SelectionActiveEndAttributeId',
    'TreeTraversalOptions_LastToFirstOrder', 'CUIAutomation',
    'AnnotationType_AdvancedProofingIssue',
    'UIA_OutlineStylesAttributeId', 'WindowInteractionState_Closing',
    'UIA_DragGrabbedItemsPropertyId', 'UIA_IsPasswordPropertyId',
    'UIA_CapStyleAttributeId', 'StructureChangeType_ChildAdded',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'IUIAutomationElementArray', 'AnnotationType_FormatChange',
    'IUIAutomationCondition', 'UIA_RangeValueIsReadOnlyPropertyId',
    'SupportedTextSelection', 'UIA_DropTarget_DragEnterEventId',
    'IUIAutomation6', 'UIA_RangeValuePatternId',
    'UIA_SplitButtonControlTypeId', 'UIA_GridItemPatternId',
    'AutomationElementMode_None', 'UIA_VisualEffectsPropertyId',
    ...
    'TextEditChangeType_Composition', 'UIA_AccessKeyPropertyId',
    'AnnotationType_SpellingError',
    'SynchronizedInputType_RightMouseDown',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_StylesShapePropertyId', 'UIA_GridItemRowSpanPropertyId',
    'UIA_WindowCanMinimizePropertyId', 'UIA_FlowsFromPropertyId',
    'UIA_StylesExtendedPropertiesPropertyId', 'ExpandCollapseState',
    'UIA_UnderlineStyleAttributeId', 'CoalesceEventsOptions_Disabled',
    'IUIAutomationDropTargetPattern', 'WindowInteractionState',
    'IUIAutomationSynchronizedInputPattern',
    'AnnotationType_FormulaError', 'ProviderOptions_OverrideProvider',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_FrameworkIdPropertyId', 'UIA_OutlineThicknessPropertyId',
    'UIA_TextEditPatternId', 'UIA_MarginLeadingAttributeId',
    'UIA_MainLandmarkTypeId', 'UIA_RotationPropertyId',
    ...
    'UIA_TableRowHeadersPropertyId', 'TreeTraversalOptions_Default',
    'ProviderOptions_RefuseNonClientSupport',
    'PropertyConditionFlags', 'UIA_IsOffscreenPropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_ThumbControlTypeId', 'UIA_MenuControlTypeId',
    'UIA_CheckBoxControlTypeId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'DockPosition_Top', 'UIA_LegacyIAccessiblePatternId',
    'IUIAutomationInvokePattern', 'UIA_FontSizeAttributeId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'IUIAutomationVirtualizedItemPattern', 'AnnotationType_Endnote',
    'UIA_RuntimeIdPropertyId',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_ScrollBarControlTypeId', 'UIA_SelectionPattern2Id',
    'UIA_TextFlowDirectionsAttributeId', 'TreeScope_Subtree',
    'UIA_SystemAlertEventId', 'UIA_ItemTypePropertyId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_IsTextPattern2AvailablePropertyId', 'Assertive',
    'UIA_StyleNameAttributeId', 'TextUnit_Word',
    'UIA_IsEnabledPropertyId',
    'StructureChangeType_ChildrenInvalidated', 'DockPosition_Bottom',
    'StyleId_Heading8', 'NavigateDirection_PreviousSibling',
    'UIA_CalendarControlTypeId', 'UIA_SpinnerControlTypeId',
    'OrientationType_None', 'IUIAutomationStylesPattern',
    'UIA_StructureChangedEventId',
    'ConnectionRecoveryBehaviorOptions', 'UIA_MenuClosedEventId',
    'UIA_DataItemControlTypeId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_MarginBottomAttributeId', 'UIA_InputReachedTargetEventId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'AutomationElementMode_Full', 'UIA_HelpTextPropertyId',
    'TreeTraversalOptions_PostOrder',
    'UIA_AnnotationTypesAttributeId', 'IUIAutomationBoolCondition',
    'UIA_ToolTipClosedEventId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'IUIAutomationTextChildPattern',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'NotificationProcessing_ImportantCurrentThenMostRecent',
    'WindowVisualState_Maximized', 'ZoomUnit',
    'UIA_SemanticZoomControlTypeId', 'UIA_MenuModeEndEventId',
    'ToggleState_Off', 'UIA_ListControlTypeId', 'TreeScope_None',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_SizePropertyId', 'UIA_RangeValueMinimumPropertyId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'IUIAutomationWindowPattern', 'UIA_TransformCanResizePropertyId',
    'UIA_TreeItemControlTypeId', 'ScrollAmount_SmallIncrement',
    'SynchronizedInputType', 'UIA_WindowPatternId',
    'AnnotationType_TrackChanges', 'TreeScope',
    'UIA_SizeOfSetPropertyId', 'IUIAutomationProxyFactoryEntry',
    'UIA_LegacyIAccessibleValuePropertyId', 'StyleId_Quote',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'ScrollAmount_LargeDecrement',
    'UIA_StrikethroughStyleAttributeId', 'UIA_Invoke_InvokedEventId',
    'UIA_TransformCanRotatePropertyId', 'WindowVisualState_Normal',
    'NotificationKind', 'UIA_FullDescriptionPropertyId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'SupportedTextSelection_Single',
    'IUIAutomationSelectionItemPattern', 'StructureChangeType',
    'UIA_TransformPattern2Id', 'UIA_IsDialogPropertyId',
    'UIA_InputDiscardedEventId', 'AnnotationType_Header',
    'UIA_ListItemControlTypeId', 'UIA_AutomationIdPropertyId',
    'UIA_DataGridControlTypeId', 'UIA_GridItemColumnPropertyId',
    'IUIAutomationTransformPattern', 'UIA_StyleIdAttributeId',
    'ProviderOptions_UseClientCoordinates',
    'UIA_AsyncContentLoadedEventId', 'UIA_SeparatorControlTypeId',
    'NavigateDirection_FirstChild', 'AnnotationType_Footnote',
    'ProviderOptions_HasNativeIAccessible',
    'TextPatternRangeEndpoint', 'UIA_SayAsInterpretAsMetadataId',
    'ZoomUnit_NoAmount', 'HeadingLevel8', 'TreeScope_Element',
    'WindowVisualState', 'CoalesceEventsOptions',
    'UIA_Selection2ItemCountPropertyId',
    'UIA_StylesFillColorPropertyId', 'ToggleState',
    'SupportedTextSelection_None', 'UIA_LabeledByPropertyId',
    'HeadingLevel3', 'ScrollAmount_SmallDecrement',
    'UIA_IsDockPatternAvailablePropertyId', 'UIA_WindowControlTypeId',
    'UIA_AnimationStyleAttributeId', 'UIA_CustomNavigationPatternId',
    'IUIAutomationTextRange2', 'UIA_ToolBarControlTypeId',
    'UIA_AutomationFocusChangedEventId',
    'AnnotationType_GrammarError', 'NotificationKind_ItemAdded',
    'UIA_LineSpacingAttributeId', 'UIA_OrientationPropertyId',
    'IUIAutomationElement4', 'AutomationElementMode',
    'UIA_CaretBidiModeAttributeId', 'RowOrColumnMajor_RowMajor',
    'OrientationType_Vertical', 'AnnotationType_Author',
    'UIA_NamePropertyId', 'UIA_IsKeyboardFocusablePropertyId',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_CenterPointPropertyId', 'HeadingLevel1',
    'ExpandCollapseState_Expanded',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'TextEditChangeType', 'UIA_Text_TextChangedEventId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_StatusBarControlTypeId', 'DockPosition_Right',
    'IUIAutomationNotCondition', 'StyleId_NumberedList',
    'WindowInteractionState_BlockedByModalWindow',
    'IUIAutomationDockPattern', 'UIA_GridPatternId',
    'IUIAutomationAnnotationPattern', 'UIA_MenuBarControlTypeId',
    'UIA_MarginTopAttributeId', 'UIA_LocalizedLandmarkTypePropertyId',
    'UIA_PaneControlTypeId', 'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_IsRequiredForFormPropertyId', 'UIA_TabsAttributeId',
    ...
    'UIA_IsReadOnlyAttributeId', 'NotificationProcessing_MostRecent',
    'UIA_Transform2CanZoomPropertyId', 'AnnotationType_Comment',
    'UIA_InputReachedOtherElementEventId',
    'UIA_IsDragPatternAvailablePropertyId',
    'IUIAutomationExpandCollapsePattern', 'UIA_ToolTipOpenedEventId',
    'UIA_LocalizedControlTypePropertyId',
    'UIA_IsDataValidForFormPropertyId',
    'ProviderOptions_UseComThreading', 'DockPosition_None',
    'IUIAutomationSelectionPattern2', 'UIA_RangeValueValuePropertyId',
    'UIA_GridRowCountPropertyId', 'TreeTraversalOptions',
    'StyleId_Heading3', 'UIA_AnnotationDateTimePropertyId',
    'ExpandCollapseState_Collapsed', 'ExpandCollapseState_LeafNode',
    'SynchronizedInputType_KeyDown', 'UIA_SpreadsheetItemPatternId',
    'IUIAutomationTextRange3', 'IUIAutomationChangesEventHandler',
    ...
    'UIA_ScrollHorizontalViewSizePropertyId', 'TreeScope_Children',
    'UIA_FlowsToPropertyId', 'UIA_MenuOpenedEventId',
    'UIA_SummaryChangeId', 'UIA_IsTextPatternAvailablePropertyId',
    'UIA_AnnotationTargetPropertyId',
    'UIA_AnnotationObjectsAttributeId', 'TextUnit_Character',
    'UIA_TablePatternId', 'UIA_ChangesEventId',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'IUIAutomationCacheRequest', 'CoalesceEventsOptions_Enabled',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'IUIAutomationRangeValuePattern', 'IUIAutomationValuePattern',
    'IUIAutomationTextEditPattern', 'UIA_HyperlinkControlTypeId',
    'UIA_IsActiveAttributeId', 'ToggleState_On', 'TextUnit',
    'UIA_CustomLandmarkTypeId', 'TreeScope_Ancestors',
    'UIA_Transform2ZoomMinimumPropertyId',
    'IUIAutomationSpreadsheetPattern',
    'AnnotationType_DeletionChange', 'UIA_PositionInSetPropertyId',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'NotificationKind_ActionCompleted',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_DropTarget_DroppedEventId',
    'IUIAutomationMultipleViewPattern',
    'UIA_AutomationPropertyChangedEventId', 'IUIAutomationElement8',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_LayoutInvalidatedEventId', 'UIA_FontNameAttributeId',
    'DockPosition_Left', 'UIA_TextControlTypeId',
    'UIA_RangeValueMaximumPropertyId',
    'NotificationKind_ActionAborted', 'UIA_AcceleratorKeyPropertyId',
    'UIA_SayAsInterpretAsAttributeId',
    'RowOrColumnMajor_Indeterminate', 'UIA_TogglePatternId',
    'StyleId_Heading6', 'UIA_EditControlTypeId',
    'UIA_IsHiddenAttributeId', 'IUIAutomationElement7',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_OutlineColorPropertyId', 'IUIAutomationEventHandlerGroup',
    'IUIAutomationObjectModelPattern',
    'IUIAutomationItemContainerPattern',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'AnnotationType_Footer', 'StyleId_Emphasis', 'IUIAutomation2',
    'UIA_BackgroundColorAttributeId', 'StyleId_Heading5',
    'RowOrColumnMajor_ColumnMajor', 'OrientationType_Horizontal',
    'IUIAutomationScrollItemPattern', 'UIA_OverlineStyleAttributeId',
    'NavigateDirection_LastChild', 'UIA_ButtonControlTypeId',
    'AnnotationType_CircularReferenceError',
    'IUIAutomationTextRangeArray', 'UIA_DragPatternId',
    'UIA_TransformPatternId', 'UIA_GridItemColumnSpanPropertyId',
    'UIA_SliderControlTypeId', 'UIA_TabControlTypeId',
    'UIA_NavigationLandmarkTypeId', 'AnnotationType_MoveChange',
    'UIA_DragDropEffectsPropertyId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'TextPatternRangeEndpoint_End', 'ZoomUnit_SmallIncrement',
    'UIA_BulletStyleAttributeId', 'UIA_GridColumnCountPropertyId',
    'UIA_FillColorPropertyId', 'StyleId_BulletedList',
    'NotificationProcessing_All', 'UIA_SynchronizedInputPatternId',
    'AnnotationType_UnsyncedChange', 'TreeScope_Descendants',
    'UIA_FillTypePropertyId', 'UIA_TreeControlTypeId',
    'HeadingLevel5', 'WindowInteractionState_NotResponding',
    'UIA_ToggleToggleStatePropertyId', 'UIA_Drag_DragStartEventId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'SupportedTextSelection_Multiple', 'UIA_VirtualizedItemPatternId',
    'IUIAutomation', 'UIA_DockDockPositionPropertyId',
    'UIA_DescribedByPropertyId', 'UIA_FormLandmarkTypeId',
    'UIA_RangeValueLargeChangePropertyId', 'TextEditChangeType_None',
    'TextUnit_Paragraph', 'UIA_IsItalicAttributeId',
    'PropertyConditionFlags_IgnoreCase',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_AriaPropertiesPropertyId', 'ExtendedProperty',
    'UIA_TitleBarControlTypeId', 'UIA_ValuePatternId',
    'SynchronizedInputType_LeftMouseUp', 'IAccessible',
    'UIA_ExpandCollapsePatternId', 'UIA_AriaRolePropertyId',
    'AnnotationType_Sensitive',
    'UIA_TableItemRowHeaderItemsPropertyId', 'HeadingLevel7',
    'UIA_IsStylesPatternAvailablePropertyId', 'OrientationType',
    'RowOrColumnMajor', 'UIA_Transform2ZoomLevelPropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId', 'StyleId_Custom',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_Window_WindowClosedEventId', 'PropertyConditionFlags_None',
    ...
    'ScrollAmount_NoAmount', 'TextUnit_Page',
    'WindowVisualState_Minimized', 'ZoomUnit_LargeIncrement',
    'IUIAutomationPropertyCondition',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_IsSuperscriptAttributeId', 'NavigateDirection',
    'UIA_Window_WindowOpenedEventId', 'ZoomUnit_SmallDecrement',
    'UIA_TableColumnHeadersPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'TextPatternRangeEndpoint_Start', 'UIA_Drag_DragCancelEventId',
    'IUIAutomationElement6', 'NotificationKind_Other',
    'SynchronizedInputType_RightMouseUp', 'UIA_SpreadsheetPatternId',
    'UIA_IsPeripheralPropertyId', 'HeadingLevel4',
    'IRawElementProviderSimple',
    'IUIAutomationCustomNavigationPattern',
    'UIA_IsControlElementPropertyId',
    'UIA_SelectionSelectionPropertyId', 'ProviderOptions',
    'PropertyConditionFlags_MatchSubstring',
    'NotificationKind_ItemRemoved', 'StyleId_Heading1',
    'NotificationProcessing_ImportantMostRecent',
    'IUIAutomationScrollPattern', 'UIA_CulturePropertyId',
    'AnnotationType_Unknown', 'AnnotationType_ConflictingChange',
    'UIA_ForegroundColorAttributeId', 'DockPosition',
    'AnnotationType_Highlighted',
    'UIA_IsTablePatternAvailablePropertyId',
    'UIA_RangeValueSmallChangePropertyId', 'UIA_TabItemControlTypeId',
    'UIA_TableItemPatternId', 'UIA_LegacyIAccessibleRolePropertyId',
    'NavigateDirection_Parent',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_ScrollVerticalViewSizePropertyId', 'UIA_SelectionPatternId',
    'ToggleState_Indeterminate', 'IUIAutomationTogglePattern',
    'ProviderOptions_ServerSideProvider',
    'UIA_ClickablePointPropertyId', 'ScrollAmount_LargeIncrement',
    'UIA_LiveRegionChangedEventId', 'UIA_ScrollPatternId',
    'UIA_CustomControlTypeId', 'UIA_IsContentElementPropertyId',
    'AnnotationType_ExternalChange', 'IUIAutomation4',
    'UIA_StylesStyleIdPropertyId', 'SynchronizedInputType_KeyUp',
    'UIA_FontWeightAttributeId', 'UIA_ValueValuePropertyId',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_MenuModeStartEventId', 'UIA_NotificationEventId',
    'StyleId_Subtitle', 'UIA_AnnotationPatternId',
    'UIA_HeadingLevelPropertyId', 'UIA_ClassNamePropertyId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_HeaderControlTypeId', 'HeadingLevel_None',
    'DockPosition_Fill', 'UIA_DropTarget_DragLeaveEventId',
    'AnnotationType_Mathematics', 'NotificationProcessing', 'Off',
    'IUIAutomationTextPattern2', 'AnnotationType_InsertionChange',
    'StructureChangeType_ChildrenBulkRemoved',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_NativeWindowHandlePropertyId',
    'UIA_Transform2ZoomMaximumPropertyId', 'UIA_TextPatternId',
    'IUIAutomationTreeWalker', 'HeadingLevel9',
    'UIA_ToolTipControlTypeId', 'UIA_ItemContainerPatternId',
    'HeadingLevel2', 'IUIAutomationTextEditTextChangedEventHandler'
]

_check_version('1.2.0', 1776389956.220928)
