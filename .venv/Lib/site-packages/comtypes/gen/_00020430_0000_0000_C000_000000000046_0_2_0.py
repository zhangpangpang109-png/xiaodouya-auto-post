...
__all__ = [
    'Color', 'IPicture', 'FONTSTRIKETHROUGH', 'Unchecked', 'Checked',
    'FontEvents', 'StdFont', 'OLE_CANCELBOOL', 'StdPicture',
    'OLE_XSIZE_PIXELS', 'OLE_YPOS_CONTAINER', 'OLE_XSIZE_CONTAINER',
    'FONTNAME', 'OLE_TRISTATE', 'OLE_COLOR', 'OLE_YPOS_PIXELS',
    'FONTUNDERSCORE', 'FONTITALIC', 'IPictureDisp', 'Font',
    'OLE_YSIZE_HIMETRIC', 'Monochrome', 'IFontEventsDisp', 'FONTSIZE',
    'OLE_XSIZE_HIMETRIC', 'OLE_XPOS_CONTAINER', 'IFontDisp',
    'Default', 'OLE_HANDLE', 'OLE_YSIZE_CONTAINER',
    'OLE_YSIZE_PIXELS', 'Picture', 'OLE_XPOS_PIXELS', 'VgaColor',
    'OLE_ENABLEDEFAULTBOOL', 'IFont', 'OLE_XPOS_HIMETRIC',
    'OLE_OPTEXCLUSIVE', 'OLE_YPOS_HIMETRIC', 'FONTBOLD', 'Gray',
    'LoadPictureConstants'
]

_check_version('1.2.0', 1711956124.715930)
